...
// Create mail data
$headers = 'From: «Parfecoffee» <info@mysite.ru>' . "\r\n";
...
$subject = 'Заявка с лендинга «Parfecoffee»';

$phone = '';
$nameOrCity = '';
$htmlBody = "<html><body style='font-family:Arial,sans-serif;'5>";
$htmlBody .=
    "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;'>Заявка с лендинга «Parfecoffee»</h2>\r\n";
...
if (mail($sendto, $subject, $htmlBody, $headers)) {
    if (
        ...
        $customerSubject = 'Вы подали заявку на лендинге «Parfecoffee»';
